...
object WikiIndex {
    def main(args: Array[String]): Unit = {
        ...
        conf.set("es.resource", "wiki_sample_index/article")
        conf.set("es.nodes", "ec2-52-73-6-251.compute-1.amazonaws.com:9200")
        ...
        index_rdd.saveToEs("wiki_sample_index/article") 
    }
}
